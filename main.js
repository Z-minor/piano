...
function loop(){
  ...
  if(答題計時>0){
    ...
    if(當前步驟<5){
        ...
        if(答題計時>1000){
            document.getElementById('社團標誌').style = `position: fixed;z-index: 1; -webkit-filter: drop-shadow(7px 7px 15px rgba(123, 127, 255, 0.4)) drop-shadow(0px 0px 3px rgba(255, 255, 255, 0.4)) invert(0);filter: drop-shadow(7px 7px 15px rgba(123, 127, 255, 0.4)) drop-shadow(0px 0px 3px rgba(255, 255, 255, 0.4)) invert(0);right:28px;bottom: 28px;transform: scale(0.6);animation: 標誌 8s infinite;`
            答題計時=0;
            添加超連結();
        }
    }
